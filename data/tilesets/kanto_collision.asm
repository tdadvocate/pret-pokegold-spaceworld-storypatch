	...
	tilecoll WALL, OLD_CUT_TREE, FLOOR, FLOOR ; 4c
...
;	tilecoll OLD_WATERFALL | COLLFLAG_ENCOUNTER, OLD_WATERFALL | COLLFLAG_ENCOUNTER, OLD_WATERFALL | COLLFLAG_ENCOUNTER, OLD_WATERFALL | COLLFLAG_ENCOUNTER ; 6e
	tilecoll WATER | COLLFLAG_ENCOUNTER, WATER | COLLFLAG_ENCOUNTER, WATER | COLLFLAG_ENCOUNTER, WATER | COLLFLAG_ENCOUNTER ; 6e

	...
	tilecoll WALL, WALL, WALL, WATER | COLLFLAG_ENCOUNTER ; 5d
	tilecoll WALL, FLOOR, WALL, FLOOR ; 5e
	tilecoll WALL, WALL, WALL, WALL ; 5f
	tilecoll OLD_PIT_SKATE | COLLFLAG_ENCOUNTER, FLOOR, FLOOR, OLD_PIT_SKATE | COLLFLAG_ENCOUNTER ; 60
	tilecoll WALL, FLOOR, FLOOR, FLOOR ; 61
	tilecoll WALL, SIGNPOST, FLOOR, FLOOR ; 62

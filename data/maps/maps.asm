...
MapGroup_SilentHill:
	map Route1P1, TILESET_SILENT_HILL, ROUTE, LANDMARK_ROUTE_1_P1 ; Route 1 West of Silent
	map Route1P2, TILESET_SILENT_HILL, ROUTE, LANDMARK_ROUTE_1_P2 ; Route 1/2? South of Old and West of Route 1
	map RouteSilentEast, TILESET_SILENT_HILL, ROUTE, LANDMARK_ROUTE_SILENT_EAST ; Route 23 East of Silent
...
MapGroup_OldCity:
	map Route2, TILESET_OLD_CITY, ROUTE, LANDMARK_ROUTE_2 ; Route (3?) West of Old
...
MapGroup_Haiteku:
	map HaitekuWestRoute, TILESET_HAITEKU, ROUTE, LANDMARK_HAITEKU_WEST_ROUTE ; Route 6 West of High-Tech
	map HaitekuWestRouteOcean, TILESET_HAITEKU, ROUTE, LANDMARK_HAITEKU_WEST_ROUTE_OCEAN ; Route 7 South of South and West of Route 6
...
MapGroup_Fonto:
	map FontoRoute1, TILESET_FONTO, ROUTE, LANDMARK_FONTO_ROUTE_1 ; Route 9 West of Font
	map FontoRoute2, TILESET_FONTO, ROUTE, LANDMARK_FONTO_ROUTE_2 ; Route 10 North of Font
	map FontoRoute3, TILESET_FONTO, ROUTE, LANDMARK_FONTO_ROUTE_3 ; Route (11?) East of Font
	map FontoRoute4, TILESET_FONTO, ROUTE, LANDMARK_FONTO_ROUTE_4 ; Route 12 East of Font and North of Birdon (Baaadon)
	map FontoRoute5, TILESET_FONTO, ROUTE, LANDMARK_FONTO_ROUTE_5 ; Route 24 Connected to Route 10 and (??) but North of South
	map FontoRoute6, TILESET_FONTO, ROUTE, LANDMARK_FONTO_ROUTE_6 ; Route (??) Connecting 12 and 24
...
MapGroup_Baadon:
	map BaadonRoute1, TILESET_BAADON, ROUTE, LANDMARK_BAADON_ROUTE_1 ; Route 4 South of Baadon and North of West
	map BaadonRoute2, TILESET_BAADON, ROUTE, LANDMARK_BAADON_ROUTE_2 ; Route 13 East of Baadon
	map BaadonRoute3, TILESET_BAADON, ROUTE, LANDMARK_BAADON_ROUTE_3 ; Route 14 between Route 13 and North of Route 15
...
MapGroup_Newtype:
	map Route15, TILESET_SILENT_HILL, ROUTE, LANDMARK_ROUTE_15 ; Route 15 West of Newtype
	map NewtypeRoute, TILESET_SILENT_HILL, ROUTE, LANDMARK_NEWTYPE_ROUTE ; Route (17?) East of Newtype
	map Route18, TILESET_SILENT_HILL, ROUTE, LANDMARK_ROUTE_18 ; Route 18 East of Route (17?)
...
MapGroup_Sugar:
	map SugarRoute, TILESET_HAITEKU, ROUTE, LANDMARK_SUGAR_ROUTE ; Route 16 South of Sugar and North of Newtype
...
MapGroup_Bull:
	map BullForestRoute1, TILESET_BULL_FOREST, ROUTE, LANDMARK_BULL_FOREST_ROUTE_1 ; Route 19 East of Blue Forest (Bull)
	map BullForestRoute2, TILESET_BULL_FOREST, ROUTE, LANDMARK_BULL_FOREST_ROUTE_2 ; Route 20 South of Blue Forest (Bull)
	map BullForestRoute3, TILESET_BULL_FOREST, ROUTE, LANDMARK_BULL_FOREST_ROUTE_3 ; Route 26 North of Blue Forest (Bull)
...
MapGroup_Stand:
	map StandRoute, TILESET_SILENT_HILL, ROUTE, LANDMARK_STAND_ROUTE ; Route 21 South of Stand
...
MapGroup_Kanto:
	map KantoEastRoute, TILESET_KANTO, ROUTE, LANDMARK_KANTO_EAST_ROUTE ; Route 22 East of Kanto
...
MapGroup_Prince:
	map PrinceRoute, TILESET_SILENT_HILL, ROUTE, LANDMARK_PRINCE ; Route 29 North of Silent
	map Prince, TILESET_SILENT_HILL, TOWN, LANDMARK_PRINCE

MapGroup_MtFuji:
	map MtFujiRoute, TILESET_SILENT_HILL, ROUTE, LANDMARK_MT_FUJI ; Route 29 Duplicate Minus rock formation
